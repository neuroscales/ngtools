...
def load_affine(
    ...
    fileobj : file_like or str
        ...
        `"afni://path/to/file"`. Accepted protocols are
...
def compose(
    ...
    *transforms : ng.CoordinateSpaceTransform
    ...
    lo_names_rm = [lo_names[index] for index in lo_indcs_rm]
    ...
    # Check that these axis names do not already exist in the output
